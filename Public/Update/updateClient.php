...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $email = $_POST["email"];
        if (!$first_name || !$email || !$id || !$last_name || !$phone_number) {
            die("Please fill in all fields");
        }
        include '../../Private/CRUD/update.php';
        update_client($id, $first_name, $last_name, $email, $phone_number);
    }
    ?>
    <div class="grid">
        <div class="grid-elem">
            <h2>Update Client</h2>
            <form method="post">
                Client <select name="id" class="select-button">
                    <?php
                ...
                New Client First Name <input type="text" name="first_name"><br>
                New Client Last Name <input type="text" name="last_name"><br>
                New Client Phone Number <input type="text" name="phone_number"><br>
                New Client Email <input type="text" name="email"><br>
